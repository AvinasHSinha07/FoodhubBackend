...
const renderTemplate = (templateName: string, templateData: Record<string, unknown>) => {
...
export const sendEmail = async ({ to, subject, templateName, templateData }: SendEmailPayload) => {

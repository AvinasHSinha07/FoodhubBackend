...
const getMyMealFavorites = async (customerId, queryOptions) => {
...
const getMyProviderFavorites = async (customerId, queryOptions) => {
    const [result, total] = await prisma.$transaction([
...
const toggleMealFavorite = async (customerId, mealId) => {
...
const toggleProviderFavorite = async (customerId, providerId) => {
...
const getFavoriteState = async (customerId, mealId, providerId) => {
    if (mealId) {
